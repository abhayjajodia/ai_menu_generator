...
function displayResults(data) {
    ...
    let html = `
        ...
        <p class="menu-description">${data.menu.menu_description || "DeepSeek AI has created this special menu for your event"}</p>
    `;
    ...
    // Display grocery list if self-preparation
